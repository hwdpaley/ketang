...
var _class = function (_think$adapter$base) {
     ...
     * @return {[]}         []
     */
    _class.prototype.init = function init(fileField, config, type, http) {
        type = type || "upload";
        //super.init(http);
        this.http = http;
    ...
    _class.prototype.upFile = function upFile() {
        var http = this.http;
    ...
    _class.prototype.upBase64 = function upBase64() {
        var http = this.http;
    ...
    _class.prototype.saveRemote = function () {
        var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
            var imgUrl, m, filePath, fullName, promises;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 5:
                            ...
                            think.mkdir(this.filePath.replace(this.fileName, ""));
                            _context.next = 17;
                            return this.spiderImage(imgUrl, filePath);
    ...
    _class.prototype.getFileExt = function getFileExt() {
    ...
    _class.prototype.getFullName = function getFullName() {
        //替换目录日期事件
    ...
    _class.prototype.getFileName = function getFileName() {
    ...
    _class.prototype.checkType = function checkType() {
    ...
    _class.prototype.checkSize = function checkSize() {
    ...
    _class.prototype.getFileInfo = function getFileInfo() {
        return {
            "state": this.stateInfo,
            "url": this.fullName,
            "title": this.fileName,
