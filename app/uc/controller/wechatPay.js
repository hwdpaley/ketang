...
var WechatPay = function () {
    ...
    function WechatPay(userInfo) {
        (0, _classCallCheck3.default)(this, WechatPay);
    ...
    WechatPay.prototype.getUnifiedorderXmlParams = function getUnifiedorderXmlParams(obj) {
    ...
    WechatPay.prototype.getPrepayId = function getPrepayId(obj) {
        var that = this;
        // 生成统一下单接口参数
        ...
        return new _promise2.default(function (resolve, reject) {
            ...
            request.post({ url: url, body: (0, _stringify2.default)(that.getUnifiedorderXmlParams(UnifiedorderParams)) }, function (error, response, body) {
                var prepay_id = '';
    ...
    WechatPay.prototype.getSign = function getSign(signParams) {
        // 按 key 值的ascll 排序
        var keys = (0, _keys2.default)(signParams);
        keys = keys.sort();
        var newArgs = {};
    ...
    WechatPay.prototype.getBrandWCPayParams = function getBrandWCPayParams(obj, callback) {
        var that = this;
    ...
    WechatPay.prototype.createNonceStr = function createNonceStr() {
     ...
     * 获取微信的 AccessToken
     */
    WechatPay.prototype.getAccessToken = function getAccessToken(obj, cb) {
        var that = this;
...
//# sourceMappingURL=wechatPay.js.map