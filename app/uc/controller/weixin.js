...
var _class = function (_Base) {
    ...
    _class.prototype.oauthAction = function () {
        var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
            var openid, oauthUrl, wx_user, userinfo;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                            ...
                            oauthUrl = _pingpp2.default.wxPubOauth.createOauthUrlForCode(this.setup.wx_AppID, this.setup.wx_url + '/uc/weixin/getopenid?showwxpaytitle=1', true);
    ...
    _class.prototype.getopenidAction = function () {
        var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {
            ...
            var code, getopenid, openid, userinfo, wx_user, member, _member, filePath, last_login_time, wx_userInfo;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 8:
                            ...
                            console.log("微信 userinfo 123456-------------" + (0, _stringify2.default)(userinfo));
                            //如果没有关注先跳到关注页面
                        ...
                        case 39:
                            _member = _context3.sent;

                            if (think.isEmpty(_member)) {
                                _context3.next = 44;
                                break;
                            }

                            userinfo.uid = _member.id;
                            _context3.next = 52;
                            break;
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _context4.next = 2;
                            return createLimitQRCode(this.api, 100);

                        case 2:
                            res = _context4.sent;
                            qrcod = this.api.showQRCodeURL(res.ticket);
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 13:
                            ...
                            return _context5.abrupt('return', this.display('mobile/' + this.http.controller + '/phone'));
    ...
    _class.prototype.organizingphoneAction = function () {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            ...
                            return _context7.abrupt('return', this.fail("用户昵称不能为空！"));
                        ...
                        case 7:
                            ...
                            return _context7.abrupt('return', this.fail("手机号码不能为空！"));
                        ...
                        case 21:
                            ...
                            console.log("res member----" + (0, _stringify2.default)(res));
                        ...
                        case 29:
                            ...
                            console.log("reg add----" + (0, _stringify2.default)(reg));
                        ...
                        case 31:
                            ...
                            _context7.next = 34;
                            return this.model("wx_user").where({ openid: data.openid }).update({ uid: reg, phone: data.mobile });
                        ...
                        case 46:
                            this.cookie('wx_openid', null);
                            return _context7.abrupt('return', this.success({ name: "绑定成功", url: this.cookie("bieber_wx_url") }));
        ...
        function organizingphoneAction() {
            return _ref7.apply(this, arguments);
        }

        return organizingphoneAction;
    }();
    /**登录绑定 */
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 23:
                            this.cookie('wx_openid', null);
                            //TODO 用户密钥
                            return _context8.abrupt('return', this.success({ name: "绑定成功", url: this.cookie("bieber_wx_url") }));

                        case 27:
                            //登录失败
                            fail = void 0;
                            _context8.t0 = res;
                            _context8.next = _context8.t0 === -1 ? 31 : _context8.t0 === -2 ? 33 : 35;
                            break;
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 44:
                            ...
                            return _context9.abrupt('return', this.success({ status: 0, name: "您已经拥有该拓客模板!" }));
                        ...
                        case 59:
                            _res = _context9.sent;
                            return _context9.abrupt('return', this.success({ status: 0, name: "拓客模板拷贝成功!" }));
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 9:
                            ...
                            console.log("have---------" + res);
                            return _context10.abrupt('return', this.success({ status: 0, name: "用户已经报名!" }));
                        ...
                        case 29:
                            doc = _context10.sent;
                            return _context10.abrupt('return', this.success({ status: 0, name: "用户报名成功!" }));
                        ...
                        case 43:
                            ...
                            return _context10.abrupt('return', this.success({ status: -1, name: "请先关注微信公众号，谢谢参与" }));
                        ...
                        case 63:
                            return _context10.abrupt('return', this.success({ status: -1, name: "用户报名失败!" }));
                ...
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        ...
                        case 111:
                            ...
                            return _context11.abrupt('return', this.display('mobile/' + this.http.controller + '/' + temp));
                        ...
                        case 115:
                            ...
                            return _context11.abrupt('return', this.success({ status: -1, name: "请先登录，谢谢参与" }));
                        ...
                        case 132:
                            ...
                            return _context11.abrupt('return', this.display(this.http.controller + '/' + temp));
    ...
    _class.prototype.xfmbAction = function () {
        var _ref12 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12() {
            var uurl, aa, signPackage, id, document, info, islogin, str, img, cate, keywords, temp, model, pid, pinfo, i, nav, lastinfo, plist, ptree_, ptree, model_id, p_id, table, p_info, reg, openid, map, res, oid, _map2, _res3;
            ...
            return _regenerator2.default.wrap(function _callee12$(_context12) {
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        ...
                        case 90:
                            info.fmurl = _context12.sent;
                            _context12.next = 93;
                            return get_cover2(info.twourl, this.setup.QINIU_DOMAIN_NAME);

                        case 93:
                            info.twourl = _context12.sent;
                            _context12.next = 96;
                            return get_cover2(info.twotmp, this.setup.QINIU_DOMAIN_NAME);

                        case 96:
                            info.twotmp = _context12.sent;

                            // info.twourl = '//' + this.setup.QINIU_DOMAIN_NAME + '/' + pic.path;
                            reg = new RegExp("\"//*", "g"); //创建正则RegExp对象   

                            info.content = info.content.replace(reg, "\"http://");
                            console.log("info---------" + (0, _stringify2.default)(info));
                            this.assign("info", info);
                            //console.log("description-------------" + info.description);
                            this.assign("desc", info.description);
                            openid = void 0;
                        ...
                        case 117:
                            ...
                            console.log("tuokeAction 手机========" + (this.http.controller + '/' + temp));
                            return _context12.abrupt('return', this.display('mobile/' + this.http.controller + '/' + temp));
                        ...
                        case 121:
                            ...
                            return _context12.abrupt('return', this.success({ status: -1, name: "请先登录，谢谢参与" }));
                        ...
                        case 125:
                            ...
                            console.log("PC用户 oid,--------------" + (0, _stringify2.default)(_map2));
                            _context12.next = 133;
                            return this.model("doc_wxuser").where(_map2).find();

                        case 133:
                            _res3 = _context12.sent;

                            //是否已经报名
                            if (!think.isEmpty(_res3)) {
                                this.assign("pay_type", 1);
                            } else {
                                //未报名
                                this.assign("pay_type", 0);
                        ...
                        case 138:
                            ...
                            return _context12.abrupt('return', this.display(this.http.controller + '/' + model));
