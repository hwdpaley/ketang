...
var _class = function (_Base) {
    ...
    _class.prototype.extAction = function () {
        var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
            var model_id, model, table, db, result;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            model_id = this.get('model_id');
                            _context2.next = 3;
                            return this.model("model").find(model_id);

                        case 3:
                            model = _context2.sent;
                            table = think.parseConfig(true, think.config("db")).prefix + model.name;
